...
{
    public partial class UC_СкладА : UserControl
    {
        private DB db;
        int selectedRow;
        ...
        private void UC_СкладА_Load(object sender, EventArgs e)
        {
        ...
        {
            var queryUp = $"update Склад set Код_товара = '{guna2TextBox2.Text}'," +
                $" Остаток_товара = '{guna2TextBox3.Text}'," +
