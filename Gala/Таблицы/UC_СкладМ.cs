...
{
    public partial class UC_СкладМ : UserControl
    {
        ...
        private void UC_СкладМ_Load(object sender, EventArgs e)
        {
            this.складTableAdapter.Fill(this.нестеровКурсоваяDataSet.Склад);
            chart.Series.Clear();
        }
        ...
        private void guna2TextBoxSearch_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    складBindingSource.Filter = string.Format("{0}='{1}'",
        ...
        {
            CreateChart2(guna2DataGridView1, "Количество товаров", " ");
        ...
        private void CreateChart2(DataGridView grid, string nameTitle, string seriesName)
        {
            try
            {
                ...
                chart.ChartAreas[0].AxisX.Title = grid.Columns[1].HeaderText;
                chart.ChartAreas[0].AxisY.Title = grid.Columns[2].HeaderText;
        ...
        private void guna2RadioButton3_CheckedChanged_1(object sender, EventArgs e)
        {
