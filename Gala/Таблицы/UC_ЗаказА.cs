...
{
    public partial class UC_ЗаказА : UserControl
    {
        private DB db;
        int selectedRow;
        ...
        private void UC_ЗаказА_Load(object sender, EventArgs e)
        {
            this.заказTableAdapter.Fill(this.нестеровКурсоваяDataSet.Заказ);
        }
        private void guna2Button1_Click(object sender, EventArgs e)
        {
            var queryDel = $"delete Заказ where Код_заказа = {guna2TextBox1.Text} ";
        ...
        {
            var queryAdd = $"insert into Заказ (Код_поставщика, Код_товара, Количество_товаров, Статус_заказа," +
        ...
        {
            var queryUp = $"update Заказ set Код_поставщика = '{guna2TextBox2.Text}'," +
                $" Код_товара = '{guna2TextBox3.Text}'," +
                $" Количество_товаров = '{guna2TextBox4.Text}', Статус_заказа = '{guna2TextBox5.Text}'," +
                $" Дата_завершения = '{guna2TextBox6.Text}' where Код_заказа = {guna2TextBox7.Text}";
